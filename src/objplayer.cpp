...
objPlayer::objPlayer() : mapObject("NULL", 0, 0 , 0, 0, '@', "", false)
{
    icon_list = "^>v<";
    facing = 0;
}

objPlayer::objPlayer(std::string n, int i, int t, int x, int y, std::string ic, int f) : mapObject(n, i, t, x, y, '@', "", false)
{
    icon_list = ic;
    facing = f;
}
